    ...
    return (
        <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
            <a
                ...
                aria-label="Call North Brooksville Flea Control Experts"
            >
            ...
            <div className="flex items-center gap-2 bg-white/90 backdrop-blur-sm px-4 py-1.5 rounded-full border border-slate-200 shadow-sm animate-pulse">
                ...
                <span className="text-[10px] font-bold text-slate-600 uppercase tracking-tighter">Flea Elimination Team On Standby - North Brooksville, FL - (323) 880-1224</span>
            </div>
        </div>
    );
};
