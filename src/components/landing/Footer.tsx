      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-heading font-bold text-xl block leading-none tracking-tight text-white uppercase">Lynden Yellow Jacket</span>
                <span className="text-sm font-medium text-amber-500 uppercase tracking-widest text-[10px]">Removal Pros</span>
              </div>
            </div>
            <p className="text-slate-400 mb-8 leading-relaxed font-medium italic">
              Lynden's rapid-response yellow jacket removal experts. We provide safe, professional nest extraction and colony elimination throughout Lynden and Whatcom County.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Underground Nest Removal", "Eave Nest Extraction", "Attic Colony Elimination", "Wall Void Treatment", "Emergency Night Service"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["About Us", "Coverage Area", "Contact Us", "Lease This Site"].map((item) => (
                <li key={item}>
                  <a href={item === "Lease This Site" ? "#lease-section" : "#"} className="text-slate-400 hover:text-amber-500 transition-colors font-medium flex items-center gap-2 group">
                    <div className="w-1 h-1 rounded-full bg-amber-500/40 group-hover:w-2 transition-all" />
                    {item}
                  </a>
                </li>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <address className="text-slate-400 not-italic font-medium leading-relaxed">
                  Lynden Yellow Jacket Removal Pros<br />
                  300 Front St<br />
                  Lynden, WA 98264
                </address>
              </div>
        ...
        <div className="pt-12 border-t border-slate-800 text-center">
          <p className="text-slate-500 text-sm font-medium italic mb-4">
            © {new Date().getFullYear()} Lynden Yellow Jacket Removal Pros. All rights reserved. Professional Wasp & Yellow Jacket Control Lynden, WA.
          </p>
